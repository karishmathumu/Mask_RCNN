...
python mask_rcnn.py --image /path/to/test_image.jpg --device cpu  
                            => results saved to Mask_RCNN/..mask_rcnn_out_py.jpg
python mask_rcnn.py --video /path/to/test_video.mp4 --device gpu
                            => results saved to Mask_RCNN/..mask_rcnn_out_py.avi
